...
mysql_select_db($database_iysconn, $iysconn);
$query_cevapyaz = sprintf("SELECT *, DATE_FORMAT(tarihsaat, '%%d.%%m.%%y - %%H:%%i') AS ts FROM mesajlar WHERE (alici = '%s' OR gonderen = '%s') AND mesajno = '%s'", $degerbir_cevapyaz,$degerbir_cevapyaz,$degeriki_cevapyaz);
...
mysql_select_db($database_iysconn, $iysconn);
$query_tamliste = "SELECT kadi FROM kullanici ORDER BY soyad ASC";
  ...
  <tr><!-- row 3 -->
   ...
   <td colspan="18" valign="top" bgcolor="#FFFFFF"><!-- InstanceBeginEditable name="icerik" -->
     <table width="100%"  border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="70%" class="icyazi"><p class="baslik">Mesajý Ýlet </p>
          </td>
         ...
         <td class="icyazi"><form action="<?php echo $editFormAction; ?>" method="POST" name="yolla" id="yolla">
           <table width="100%"  border="0" cellspacing="5" cellpadding="2">
             ...
             <tr class="icyazi">
               ...
               <td><strong>:</strong></td>
               <td>                 <input name="alici" type="text" class="icyazi" id="alici" size="25" maxlength="60"> <span class="formaciklama">Mesajý gönreceðiniz kiþiyi kontaklardan seçebilirsiniz.</span></td>
             </tr>
             <tr class="icyazi">
...
<?php echo $row_cevapyaz['icerik']; ?></textarea></td>
             ...
             <tr>
               <td>&nbsp;</td>
               <td>&nbsp;</td>
               <td><input name="Submit" type="submit" class="butongiris" onClick="YY_checkform('yolla','konu','#q','0','Lütfen mesajýnýzýn konusunu belirtiniz.');return document.MM_returnValue" value="Mesajý Yolla"></td>
             </tr>
           </table>
         ...
         <td valign="top" class="icyazi"><form action="" method="post" name="kontaklar" id="kontaklar">
           <table width="100%"  border="0" cellspacing="5" cellpadding="0">
             ...
             <tr>
               <td colspan="2"><select name="kisiler" size="22" class="icyazi" id="kisiler">
