...
mysql_select_db($database_iysconn, $iysconn);
$query_mesaj = sprintf("SELECT *, DATE_FORMAT(tarihsaat, '%%d.%%m.%%y - %%H:%%i') AS ts FROM mesajlar WHERE alici = '%s' AND mesajno = '%s' AND silindi = 0", $degerbir_mesaj,$degeriki_mesaj);
  ...
  <tr><!-- row 3 -->
   ...
   <td colspan="18" valign="top" bgcolor="#FFFFFF"><!-- InstanceBeginEditable name="icerik" -->
     <table width="100%"  border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="70%" class="icyazi"><p class="baslik">Mesaj </p></td>
         ...
         <td valign="top" class="icyazi"><form action="<?php echo $editFormAction; ?>" method="POST" name="islem" id="islem">
           <table width="100%"  border="0" cellpadding="0" cellspacing="7">
             <tr class="icyazi">
               ...
               <td colspan="5" class="icyazi"><?php echo $row_mesaj['gonderen']; ?></td>
             </tr>
             <tr class="icyazi">
               <td class="icyazi"><div align="right"><strong>Kime</strong></div></td>
               <td class="arabaslik"><div align="center">:</div></td>
               <td colspan="5" class="icyazi"><?php echo $row_mesaj['alici']; ?></td>
             </tr>
             <tr class="icyazi">
               <td class="icyazi"><div align="right"><strong>Tarih</strong></div></td>
               <td class="arabaslik"><div align="center">:</div></td>
               <td colspan="5" class="icyazi"><?php echo $row_mesaj['ts']; ?></td>
             </tr>
             <tr class="icyazi">
               <td class="icyazi"><div align="right"><strong>Konu</strong></div></td>
               <td class="arabaslik"><div align="center">:</div></td>
               <td width="483" class="icyazi"><?php echo $row_mesaj['konu']; ?></td>
               <td width="1" class="icyazi"><a href="mesajgonder.php"><img src="m_imaj/yenim.gif" alt="Yeni Mesaj" width="16" height="15" border="0"></a></td>
               <td width="20" class="icyazi"><a href="javascript:document.islem.submit()"><img src="m_imaj/sil.gif" alt="Mesajý Sil" width="16" height="14" border="0"></a></td>
               <td width="20" class="icyazi"><a href="mesajcevap.php?<?php echo $MM_keepURL; ?>"><img src="m_imaj/cevapm.gif" alt="Cevap Yaz" width="16" height="15" border="0"></a></td>
               <td width="17" class="icyazi"><a href="mesajilet.php?<?php echo $MM_keepURL; ?>"><img src="m_imaj/yonlendirme.gif" alt="Mesajý Ýlet" width="16" height="15" border="0"></a></td>
             </tr>
             <tr>
             ...
             <tr>
               ...
               <td class="icyazi">&nbsp;</td>
               <td colspan="5" bgcolor="#FFFFFF" class="icyazi"><?php echo str_replace("\n","<br>", $row_mesaj['icerik']);?> </td>
             </tr>
           </table>
