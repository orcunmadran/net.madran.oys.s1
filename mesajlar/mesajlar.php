...
mysql_select_db($database_iysconn, $iysconn);
$query_mesajlar = sprintf("SELECT *, DATE_FORMAT(tarihsaat, '%%d.%%m.%%y - %%H:%%i') AS ts FROM mesajlar WHERE alici = '%s' And silindi = '0' ORDER BY tarihsaat DESC", $colname_mesajlar);
  ...
  <tr><!-- row 3 -->
   ...
   <td colspan="18" valign="top" bgcolor="#FFFFFF"><!-- InstanceBeginEditable name="icerik" -->
     <table width="100%"  border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="70%" class="icyazi"><p class="baslik">Gelen Kutusu </p></td>
         <td width="30%" class="icyazi"><div align="center" class="arabaslik"></div></td>
       </tr>
       <tr>
         <td height="223" valign="top" class="icyazi">
           <form method="POST" name="goster" id="goster">
             <table width="100%"  border="0" cellspacing="5" cellpadding="0">
               <tr>
                 <td>&nbsp;</td>
                 <td width="27%" class="arabaslik">Gönderen</td>
               ...
               <tr>
                 <td><?php if ($totalRows_mesajlar > 0) { // Show if recordset not empty ?>
                       <div align="right"><img src="m_imaj/m<?php echo $row_mesajlar['okundu']; ?>.gif">
                       </div>
                       <?php } // Show if recordset not empty ?></td>
                 <td class="altbaslik"><strong class="icyazi"><?php echo $row_mesajlar['gonderen']; ?></strong></td>
                 <td class="icyazi"><a href="mesajoku.php?<?php echo $MM_keepNone.(($MM_keepNone!="")?"&":"")."mesajno=".urlencode($row_mesajlar['mesajno']) ?>"><?php echo $row_mesajlar['konu']; ?></a></td>
         ...
         <td valign="top" class="icyazi"><div align="center" class="icyazi"><!-- #BeginLibraryItem "/Library/postamerkezi.lbi" --><!--Fireworks MX Dreamweaver LBI target.  Created -->
