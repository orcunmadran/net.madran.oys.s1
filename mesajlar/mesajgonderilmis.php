...
$colname_mesajlar = "-1";
if (isset($_SESSION['MM_Username'])) {
  $colname_mesajlar = (get_magic_quotes_gpc()) ? $_SESSION['MM_Username'] : addslashes($_SESSION['MM_Username']);
}
mysql_select_db($database_iysconn, $iysconn);
  ...
  <tr><!-- row 3 -->
   ...
   <td colspan="18" valign="top" bgcolor="#FFFFFF"><!-- InstanceBeginEditable name="icerik" -->
     <table width="100%"  border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td class="icyazi"><p class="baslik">Gönderilmiþ Mesajlar</p></td>
         <td width="30%" class="icyazi">&nbsp;</td>
       </tr>
       <tr>
         <td valign="top" class="icyazi">
           <form method="POST" name="goster" id="goster">
             <table width="100%"  border="0" cellspacing="5" cellpadding="0">
               <tr>
                 <td width="6%"><div align="center" class="arabaslikuyari"></div></td>
                 <td width="27%" class="arabaslik">Alýcý</td>
                 <td width="43%" class="arabaslik">Konu</td>
                 <td width="24%" class="arabaslik">Tarih</td>
               </tr>
               <tr>
                 <td>&nbsp;</td>
                 <td class="altbaslik"><hr size="1"></td>
               ...
               <tr>
                 <td><?php if ($totalRows_mesajlar > 0) { // Show if recordset not empty ?>
                   <img src="m_imaj/m<?php echo $row_mesajlar['okundu']; ?>.gif">
                   <?php } // Show if recordset not empty ?></td>
                 <td class="altbaslik"><strong class="icyazi"><?php echo $row_mesajlar['alici']; ?></strong></td>
                 <td class="icyazi"><a href="mesajggor.php?<?php echo $MM_keepURL.(($MM_keepURL!="")?"&":"")."mesajno=".urlencode($row_mesajlar['mesajno']) ?>"><?php echo $row_mesajlar['konu']; ?></a></td>
...
<!-- #EndLibraryItem --></td>
       ...
       <tr>
         <td class="icyazi"><div align="right"><img src="m_imaj/m0.gif" width="13" height="11"> <span class="formaciklama">Mesaj alýcý tarafýndan okunmamýþ.</span></div></td>
         <td valign="top" class="icyazi">&nbsp;</td>
       </tr>
       <tr>
         <td class="icyazi"><div align="right"><img src="m_imaj/m1.gif" width="13" height="12"> <span class="formaciklama">Mesajý alýcý tarafýndan okunmuþ.</span></div></td>
         <td valign="top" class="icyazi">&nbsp;</td>
       </tr>
     </table>
