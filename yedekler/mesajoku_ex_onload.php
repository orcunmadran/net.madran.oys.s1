...
<meta http-equiv="refresh" content="1;URL=../mesajlar/mesaj.php?mesajno=<?php echo $row_oku['mesajno']; ?>">
</head>

<body onUnload="MM_callJS('document.oku.submit()')">
