...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "yayinla")) {
  $updateSQL = sprintf("UPDATE dersler_sohbet SET subeno=%s, sohbetgun=%s, sohbetsaat=%s, baslamatarih=%s, bitistarih=%s, aciklama=%s WHERE sohbetno=%s",
                       GetSQLValueString($_POST['subeno'], "int"),
                       GetSQLValueString($_POST['sohbetgun'], "text"),
                       GetSQLValueString($_POST['sohbetsaat'], "text"),
  ...
  $updateGoTo = "dersler_ssg.php?bilgi= > Sohbet bilgisi güncellendi";
  if (isset($_SERVER['QUERY_STRING'])) {
...
if (isset($_GET['sohbetno'])) {
  $colname_sohbet = (get_magic_quotes_gpc()) ? $_GET['sohbetno'] : addslashes($_GET['sohbetno']);
}
mysql_select_db($database_iysconn, $iysconn);
$query_sohbet = sprintf("SELECT *, DATE_FORMAT(baslamatarih, '%%d.%%m.%%y') AS bast, DATE_FORMAT(bitistarih, '%%d.%%m.%%y') AS bitt FROM dersler_sohbet WHERE sohbetno = %s", $colname_sohbet);
  ...
  <tr><!-- row 3 -->
   ...
   <td colspan="14" valign="top" bgcolor="#FFFFFF"><!-- InstanceBeginEditable name="icerik" -->
     <table width="100%"  border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="77%" class="baslik"><a href="dersler.php"><?php echo $row_ders['desu']; ?></a> Sohbet Saati Güncelle <span class="baslikuyari"><?php echo $_GET['bilgi']; ?></span></td>
         <td width="23%">&nbsp;</td>
       </tr>
       <tr>
         <td colspan="2"><form action="<?php echo $editFormAction; ?>" method="POST" name="yayinla" id="yayinla">
           <table width="100%"  border="0" cellspacing="5" cellpadding="5">
             <tr class="icyazi">
               <td width="13%"><div align="right"><strong>Sohbet Günü </strong></div></td>
               <td width="2%"><div align="center"><strong>:</strong></div></td>
               <td width="85%"><select name="sohbetgun" class="icyazi" id="sohbetgun">
                 <option value="<?php echo $row_sohbet['sohbetgun']; ?>" selected>Deðiþiklik yok</option>
                 <option value="1">Pazartesi</option>
                 <option value="2">Salý</option>
                 <option value="3">Çarþamba</option>
                 <option value="4">Perþembe</option>
                 <option value="5">Cuma</option>
                 <option value="6">Cumartesi</option>
                 <option value="0">Pazar</option>
               </select>
                 <?php echo $row_sohbet['sohbetgun']; ?></td>
             </tr>
             <tr class="icyazi">
               <td><div align="right"><strong>Sohbet Saat </strong></div></td>
               <td><div align="center"><strong>:</strong></div></td>
               <td><select name="sohbetsaat" class="icyazi" id="sohbetsaat">
                 <option value="<?php echo $row_sohbet['sohbetsaat']; ?>" selected>Deðiþiklik yok</option>
                 <option>08:00</option>
                 <option>08:30</option>
                 <option>09:00</option>
                 <option>09:30</option>
                 ...
                 <?php echo $row_sohbet['sohbetsaat']; ?></td>
             </tr>
             <tr class="icyazi">
               <td><div align="right"><strong>Baþlama Tarihi </strong></div></td>
               <td><div align="center"><strong>:</strong></div></td>
               <td><input name="baslamatarih" type="text" class="icyazi" id="baslamatarih" value="<?php echo $row_sohbet['baslamatarih']; ?>" size="15">                 
                 <strong>
                 <script language="JavaScript" type="text/javascript">
...
&nbsp;</strong><?php echo $row_sohbet['bast']; ?></td>
             </tr>
             <tr class="icyazi">
               <td><div align="right"><strong>Bitiþ Tarihi </strong></div></td>
               <td><div align="center"><strong>:</strong></div></td>
               <td><input name="bitistarih" type="text" class="icyazi" id="bitistarih" value="<?php echo $row_sohbet['bitistarih']; ?>" size="15">
                 <script language="JavaScript" type="text/javascript">
...
&nbsp; <?php echo $row_sohbet['bitt']; ?>                <strong>                 </strong></td>
             </tr>
             <tr class="icyazi">
               <td valign="top"><div align="right"><strong>Açýklama</strong></div></td>
               <td valign="top"><div align="center"><strong>:</strong></div></td>
               <td><textarea name="aciklama" cols="50" rows="5" class="icyazi" id="aciklama"><?php echo $row_sohbet['aciklama']; ?></textarea></td>
             </tr>
             <tr class="icyazi">
               <td valign="top"><div align="right">
                 <input name="sohbetno" type="hidden" id="sohbetno" value="<?php echo $row_sohbet['sohbetno']; ?>">
                 <input name="subeno" type="hidden" id="subeno" value="<?php echo $row_sohbet['subeno']; ?>">
               </div></td>
               <td valign="top">&nbsp;</td>
               <td><input name="Submit" type="submit" class="butongiris" onClick="YY_checkform('form1','baslamatarih','#q','0','Sohbet saatlerinin baþlama tarihini giriniz.','bitistarih','#q','0','Sohbet saatlerinin bitiþ tarihini giriniz.');return document.MM_returnValue" value="Sohbet Saatini Güncelle"></td>
             </tr>
           </table>
           
             <input type="hidden" name="MM_update" value="yayinla">
         </form></td>
        </tr>
       <tr>
         <td colspan="2"><?php if ($totalRows_sohbet > 0) { // Show if recordset not empty ?>
           <table width="100%"  border="0" cellspacing="5" cellpadding="5">
             <tr class="icyazi">
               <td><div align="center"><strong>Sohbet Günü </strong></div></td>
               <td><div align="center"><strong>Sohbet Saati </strong></div></td>
               <td><div align="center"><strong>Baþlama Tarihi</strong></div></td>
               <td><div align="center"><strong>Bitiþ Tarihi </strong></div></td>
               <td><div align="center"><strong>Güncelle</strong></div></td>
               <td><div align="center"><strong>Sil</strong></div></td>
             </tr>
             <?php do { ?>
             <tr class="icyazi">
               <td><div align="center"><?php echo $row_sohbet['sohbetgun']; ?></div></td>
               <td><div align="center"><?php echo $row_sohbet['sohbetsaat']; ?></div></td>
               <td><div align="center"><?php echo $row_sohbet['bast']; ?></div></td>
               <td><div align="center"><?php echo $row_sohbet['bitt']; ?></div></td>
               <td><div align="center"><a href="dersler_ssg.php?<?php echo $MM_keepURL.(($MM_keepURL!="")?"&":"")."sohbetno=".urlencode($row_sohbet['sohbetno']) ?>"> <img src="../../resimler/guncelle.gif" width="16" height="16" border="0"> </a></div></td>
               <td><div align="center"> <a href="dersler_sss.php?<?php echo $MM_keepURL.(($MM_keepURL!="")?"&":"")."sohbetno=".urlencode($row_sohbet['sohbetno']) ?>"><img src="../../mesajlar/m_imaj/sil.gif" width="16" height="14" border="0"></a> </div></td>
             </tr>
