...
$deger_dersliste = "-1";
if (isset($_SESSION['MM_Username'])) {
  $deger_dersliste = (get_magic_quotes_gpc()) ? $_SESSION['MM_Username'] : addslashes($_SESSION['MM_Username']);
}
mysql_select_db($database_iysconn, $iysconn);
$query_dersliste = sprintf("SELECT DISTINCT  CONCAT(DE.derskodu,  ' - ', SU.subekodu) AS desu, DE.dersadi, SU.sorumlu, SU.subeno FROM dersler DE, subeler SU WHERE DE.dersno = SU.dersno AND SU.sorumlu = '%s' ORDER BY desu", $deger_dersliste);
$dersliste = mysql_query($query_dersliste, $iysconn) or die(mysql_error());
$row_dersliste = mysql_fetch_assoc($dersliste);
$totalRows_dersliste = mysql_num_rows($dersliste);
  ...
  <tr><!-- row 3 -->
   ...
   <td colspan="14" valign="top" bgcolor="#FFFFFF"><!-- InstanceBeginEditable name="icerik" -->
     <table width="100%"  border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="70%"><span class="icyazi"><span class="baslik">Bu dönem sorumlu olduðunuz dersler</span></span></td>
         <td width="30%">&nbsp;</td>
       </tr>
       <tr>
         <td colspan="2"><span class="arabaslik"><?php echo $_GET['bilgi']; ?></span></td>
        </tr>
       <tr>
         <td colspan="2"><table width="100%"  border="0" cellspacing="5" cellpadding="5">
           <tr class="icyazi">
             <td width="16%"><div align="center"><strong>Ders Kodu &amp; Þube </strong></div></td>
             <td width="37%"><strong>Ders Adý </strong></td>
             <td width="10%"><div align="center"><strong>Ders Planý</strong></div></td>
             <td width="13%"><div align="center"><strong>Sohbet Saatleri</strong></div></td>
             <td width="8%"><div align="center"><strong>Sýnavlar</strong></div></td>
             <td><div align="center"><strong>Projeler </strong><strong>ve Ödevler</strong></div>               </td>
             </tr>
           <?php do { ?>
           <tr class="icyazi">
               <td><div align="center"><?php echo $row_dersliste['desu']; ?> </div></td>
               <td><?php echo $row_dersliste['dersadi']; ?></td>
               <td><div align="center"> <a href="dersler_po.php?<?php echo $MM_keepURL.(($MM_keepURL!="")?"&":"")."subeno=".urlencode($row_dersliste['subeno']) ?>"><img src="../../resimler/girguncelle.gif" alt="Ders Planý Gir / Güncelle" width="16" height="16" border="0"></a></div></td>
               <td><div align="center"><a href="dersler_ssb.php?<?php echo $MM_keepURL.(($MM_keepURL!="")?"&":"")."subeno=".urlencode($row_dersliste['subeno']) ?>"><img src="../../resimler/girguncelle.gif" alt="Sohbet Saati Belirle / Güncelle" width="16" height="16" border="0"></a></div></td>
               <td><div align="center"><a href="dersler_snb.php?<?php echo $MM_keepURL.(($MM_keepURL!="")?"&":"")."subeno=".urlencode($row_dersliste['subeno']) ?>"><img src="../../resimler/girguncelle.gif" alt="Sýnav Bilgisi Gir / Güncelle" width="16" height="16" border="0"></a></div></td>
               <td><div align="center"><a href="dersler_opv.php?<?php echo $MM_keepURL.(($MM_keepURL!="")?"&":"")."subeno=".urlencode($row_dersliste['subeno']) ?>"><img src="../../resimler/girguncelle.gif" alt="Proje ve Ödev Bilgisi Gir / Güncelle" width="16" height="16" border="0"></a></div>                 
               <div align="center"></div></td>
              </tr>
           <?php } while ($row_dersliste = mysql_fetch_assoc($dersliste)); ?>
         </table></td>
        </tr>
     </table>
