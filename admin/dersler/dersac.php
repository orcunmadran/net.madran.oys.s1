...
if (isset($_POST[$MM_flag])) {
  $MM_dupKeyRedirect="dersac.php?bilgi= > Bu ders kodu ile açýlmýþ olan bir ders var!";
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "dersac")) {
  ...
  $insertGoTo = "dersac.php?bilgi= > Yeni ders baþarýyla açýldý.";
  if (isset($_SERVER['QUERY_STRING'])) {
  ...
  <tr><!-- row 3 -->
   ...
   <td colspan="14" valign="top" bgcolor="#FFFFFF"><!-- InstanceBeginEditable name="icerik" -->
     <table width="100%"  border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="70%" class="baslikuyari"><span class="baslik">Yeni Ders Aç</span> <?php echo $_GET['bilgi'];?></td>
         <td width="30%">&nbsp;</td>
       </tr>
       <tr>
         <td valign="top"><form action="<?php echo $editFormAction; ?>" method="POST" name="dersac" id="dersac">
           <table width="100%"  border="0" cellspacing="5" cellpadding="5">
             ...
             <tr class="icyazi">
               <td><div align="right"><strong>Ders Adý </strong></div></td>
             ...
             <tr>
               <td>&nbsp;</td>
               <td>&nbsp;</td>
               <td><input name="Submit" type="submit" class="butongiris" onClick="MM_validateForm('derskodu','','R','dersadi','','R');return document.MM_returnValue" value="Ders Aç"></td>
             </tr>
           </table>
           <input type="hidden" name="MM_insert" value="dersac">
         </form>           </td>
         <td valign="top"><p class="altbaslik">Yeni bir ders açacaksanýz:</p>
           <p class="icyazi">Aþaðýda yer alan ders listesinden yaratmak istediðiniz dersin daha önceden açýlýp açýlmadýðýna bakabilirsiniz. </p>
           <p class="altbaslik">Yeni bir ders açtýysanýz:</p>
           <p class="altbaslik"><span class="icyazi">Bir sonraki aþama olan &quot;<a href="subeolustur.php">Þube Oluþtur</a>&quot; bölümüne geçebilirsiniz.</span></p></td>
       </tr>
       <tr>
       ...
       <tr>
         <td class="arabaslik">Þu an sistemde <span class="arabaslikuyari"><?php echo $totalRows_mvcders ?></span> adet kayýtlý ders bulunmaktadýr.</td>
         <td><div align="center">
         ...
         <td colspan="2"><?php if ($totalRows_mvcders > 0) { // Show if recordset not empty ?>
           <table width="100%"  border="0" cellspacing="5" cellpadding="0">
             <tr class="icyazi">
                ...
                <td width="73%"><strong>Ders Adý </strong></td>
             </tr>
             <?php do { ?>
             <tr class="icyazi">
