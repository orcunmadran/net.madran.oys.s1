...
if ((isset($_GET['sohbetno'])) && ($_GET['sohbetno'] != "")) {
  $deleteSQL = sprintf("DELETE FROM dersler_sohbet WHERE sohbetno=%s",
                       GetSQLValueString($_GET['sohbetno'], "int"));

  mysql_select_db($database_iysconn, $iysconn);
  $Result1 = mysql_query($deleteSQL, $iysconn) or die(mysql_error());

  $deleteGoTo = "dersler_ssb.php?bilgi=  > Kayýt baþarýyla silindi.";
