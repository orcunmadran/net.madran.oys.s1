...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "yayinla")) {
  $insertSQL = sprintf("INSERT INTO dersler_op (subeno, optipi, opadi, aciklama, ttarihi) VALUES (%s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "dersler_opv.php?bilgi= > Ödev / Proje baþarýyla yayýnlandý.";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$colname_op = "-1";
if (isset($_GET['subeno'])) {
  $colname_op = (get_magic_quotes_gpc()) ? $_GET['subeno'] : addslashes($_GET['subeno']);
}
mysql_select_db($database_iysconn, $iysconn);
$query_op = sprintf("SELECT *,  DATE_FORMAT(ttarihi, '%%d.%%m.%%y') AS tt FROM dersler_op WHERE subeno = %s", $colname_op);
  ...
  <tr><!-- row 3 -->
   ...
   <td colspan="14" valign="top" bgcolor="#FFFFFF"><!-- InstanceBeginEditable name="icerik" -->
     <table width="100%"  border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="77%" class="baslik"><a href="dersler.php"><?php echo $row_ders['desu']; ?></a> Ödev / Proje Ver <span class="baslikuyari"><?php echo $_GET['bilgi']; ?></span></td>
         <td width="23%">&nbsp;</td>
       </tr>
       <tr>
         <td colspan="2"><form action="<?php echo $editFormAction; ?>" method="POST" name="yayinla" id="yayinla">
           <table width="100%"  border="0" cellspacing="5" cellpadding="5">
             ...
             <tr class="icyazi">
               ...
               <td><input name="opadi" type="text" class="icyazi" id="opadi" size="50" maxlength="255"></td>
             </tr>
             <tr class="icyazi">
             ...
             <tr class="icyazi">
               ...
               <td><input name="ttarihi" type="text" class="icyazi" id="ttarihi" size="15">
                 <strong>
                 <script language="JavaScript" type="text/javascript">
             ...
             <tr class="icyazi">
               ...
               <td valign="top">&nbsp;</td>
               <td><input name="Submit" type="submit" class="butongiris" onClick="YY_checkform('yayinla','opadi','#q','0','Ödev / Proje adýný giriniz.','ttarihi','#q','0','Teslim Tarihini giriniz.','optipi','#q','1','Ödev / Proje seçiminizi yapýnýz.');return document.MM_returnValue" value="Ödev / Proje Ver"></td>
             </tr>
           </table>
