...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "yayinla")) {
  $updateSQL = sprintf("UPDATE dersler_plan SET tanimamac=%s, degerlendirme=%s, kaynakca=%s, kapsamicerik=%s, egitimicerigi=%s WHERE subeno=%s",
  ...
  $updateGoTo = "dersler_pg.php?bilgig= > Ders Planý baþarýyla güncellendi.";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$colname_guncelle = "-1";
if (isset($_GET['subeno'])) {
  $colname_guncelle = (get_magic_quotes_gpc()) ? $_GET['subeno'] : addslashes($_GET['subeno']);
}
mysql_select_db($database_iysconn, $iysconn);
$query_guncelle = sprintf("SELECT * FROM dersler_plan WHERE subeno = %s", $colname_guncelle);
  ...
  <tr><!-- row 3 -->
   ...
   <td colspan="14" valign="top" bgcolor="#FFFFFF"><!-- InstanceBeginEditable name="icerik" -->
     <table width="100%"  border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td colspan="2" class="baslik"><a href="dersler.php"><?php echo $row_ders['desu']; ?></a> dersinin planýný güncelle <span class="baslikuyari"><?php echo $_GET['bilgig']; ?></span></td>
        </tr>
       <tr>
         <td width="70%"><form action="<?php echo $editFormAction; ?>" method="POST" name="yayinla" id="yayinla">
           <table width="100%"  border="0" cellpadding="0" cellspacing="5">
             <tr>
               ...
               <td width="68%"><textarea name="tanimamac" cols="65" rows="7" class="icyazi" id="tanimamac"><?php echo $row_guncelle['tanimamac']; ?></textarea></td>
             </tr>
             <tr>
               ...
               <td><textarea name="degerlendirme" cols="65" rows="7" class="icyazi" id="degerlendirme"><?php echo $row_guncelle['degerlendirme']; ?></textarea></td>
             </tr>
             <tr>
               <td valign="top" class="icyazi"><div align="right"><strong>Kaynakça</strong></div></td>
               <td valign="top" class="icyazi"><div align="center"><strong>:</strong></div></td>
               <td><textarea name="kaynakca" cols="65" rows="10" class="icyazi" id="kaynakca"><?php echo $row_guncelle['kaynakca']; ?></textarea></td>
             </tr>
             <tr>
               <td valign="top" class="icyazi"><div align="right"><strong>Kapsam ve Ýçerik </strong></div></td>
               <td valign="top" class="icyazi"><div align="center"><strong>:</strong></div></td>
               <td><textarea name="kapsamicerik" cols="65" rows="10" class="icyazi" id="kapsamicerik"><?php echo $row_guncelle['kapsamicerik']; ?></textarea></td>
             </tr>
             <tr>
               <td><div align="right" class="icyazi style1">
                 <div align="right">Ders Ýçeriðinin Adresi</div>
               </div></td>
               <td><div align="center"><strong>:</strong></div></td>
               <td><input name="egitimicerigi" type="text" class="icyazi" id="egitimicerigi" value="<?php echo $row_guncelle['egitimicerigi']; ?>" size="40" maxlength="100"></td>
             </tr>
             <tr>
               <td><div align="right">
                 <input name="subeno" type="hidden" id="subeno" value="<?php echo $row_guncelle['subeno']; ?>">
               </div></td>
               <td>&nbsp;</td>
               <td><input name="Submit" type="submit" class="butongiris" value="Ders Planýný Güncelle"></td>
             </tr>
           </table>
