...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "yayinla")) {
  $insertSQL = sprintf("INSERT INTO dersler_sohbet (subeno, sohbetgun, sohbetsaat, baslamatarih, bitistarih, aciklama) VALUES (%s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "dersler_ssb.php?bilgi= > Sohbet saati belirlendi.";
  if (isset($_SERVER['QUERY_STRING'])) {
  ...
  <tr><!-- row 3 -->
   ...
   <td colspan="14" valign="top" bgcolor="#FFFFFF"><!-- InstanceBeginEditable name="icerik" -->
     <table width="100%"  border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="77%" class="baslik"><a href="dersler.php"><?php echo $row_ders['desu']; ?></a> Sohbet Saati Belirle <span class="baslikuyari"><?php echo $_GET['bilgi']; ?></span></td>
         <td width="23%">&nbsp;</td>
       </tr>
       <tr>
         <td colspan="2"><form action="<?php echo $editFormAction; ?>" method="POST" name="yayinla" id="yayinla">
           <table width="100%"  border="0" cellspacing="5" cellpadding="5">
             ...
             <tr class="icyazi">
               ...
               <td valign="top">&nbsp;</td>
               <td><input name="Submit" type="submit" class="butongiris" onClick="YY_checkform('form1','baslamatarih','#q','0','Sohbet saatlerinin baþlama tarihini giriniz.','bitistarih','#q','0','Sohbet saatlerinin bitiþ tarihini giriniz.');return document.MM_returnValue" value="Sohbet Saatini Yayýnla"></td>
             </tr>
           </table>
