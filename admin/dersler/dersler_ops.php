...
if ((isset($_GET['opno'])) && ($_GET['opno'] != "")) {
  $deleteSQL = sprintf("DELETE FROM dersler_op WHERE opno=%s",
                       GetSQLValueString($_GET['opno'], "int"));

  mysql_select_db($database_iysconn, $iysconn);
  $Result1 = mysql_query($deleteSQL, $iysconn) or die(mysql_error());

  $deleteGoTo = "dersler_opv.php?bilgi=  > Kayýt baþarýyla silindi.";
