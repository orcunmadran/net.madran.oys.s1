...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "yayinla")) {
  $updateSQL = sprintf("UPDATE dersler_snvtar SET subeno=%s, sinavtipi=%s, sinavyeri=%s, baslamatarih=%s, bitistarih=%s, sinavsaat=%s, aciklama=%s WHERE snvtrhno=%s",
                       ...
                       GetSQLValueString($_POST['snvtrhno'], "int"));

  mysql_select_db($database_iysconn, $iysconn);
  $Result1 = mysql_query($updateSQL, $iysconn) or die(mysql_error());

  $updateGoTo = "dersler_sng.php?bilgi= > Sýnav Bilgileri baþarýyla güncellendi.";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$colname_sinav = "-1";
if (isset($_GET['snvtrhno'])) {
  $colname_sinav = (get_magic_quotes_gpc()) ? $_GET['snvtrhno'] : addslashes($_GET['snvtrhno']);
}
mysql_select_db($database_iysconn, $iysconn);
$query_sinav = sprintf("SELECT *, DATE_FORMAT(baslamatarih, '%%d.%%m.%%y') AS bast, DATE_FORMAT(bitistarih, '%%d.%%m.%%y') AS bitt FROM dersler_snvtar WHERE snvtrhno = %s ORDER BY baslamatarih", $colname_sinav);
  ...
  <tr><!-- row 3 -->
   ...
   <td colspan="14" valign="top" bgcolor="#FFFFFF"><!-- InstanceBeginEditable name="icerik" -->
     <table width="100%"  border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="77%" class="baslik"><a href="dersler.php"><?php echo $row_ders['desu']; ?></a> Sýnav Tarihi Güncelle <span class="baslikuyari"><?php echo $_GET['bilgi']; ?></span></td>
         <td width="23%">&nbsp;</td>
       </tr>
       <tr>
           ...
           <table width="100%"  border="0" cellspacing="5" cellpadding="5">
             <tr class="icyazi">
               ...
               <td width="80%"><select name="sinavtipi" class="icyazi" id="sinavtipi">
                 <option value="<?php echo $row_sinav['sinavtipi']; ?>" selected>Deðiþiklik yok</option>
                 <option>Deneme Sýnavý</option>
                 <option>Mini Test</option>
                 <option>Arasýnav</option>
                 <option>Final Sýnavý</option>
                                                            </select>
                 <?php echo $row_sinav['sinavtipi']; ?></td>
             </tr>
             <tr class="icyazi">
               <td><div align="right"><strong>Sýnav Yeri </strong></div></td>
               <td><div align="center"><strong>:</strong></div></td>
               <td>                 <select name="sinavyeri" class="icyazi" id="sinavyeri">
                 <option value="<?php echo $row_sinav['sinavyeri']; ?>" selected>Deðiþiklik yok</option>
                 <option>Ýnternet Üzerinden</option>
                 <option>Merkezde Yüzyüze</option>
                                               </select>
                 <?php echo $row_sinav['sinavyeri']; ?>                 </td>
             </tr>
             <tr class="icyazi">
               <td><div align="right"><strong>Baþlama Tarihi </strong></div></td>
               <td><div align="center"><strong>:</strong></div></td>
               <td><input name="baslamatarih" type="text" class="icyazi" id="baslamatarih" value="<?php echo $row_sinav['baslamatarih']; ?>" size="15">                 
                 <strong>
                 <script language="JavaScript" type="text/javascript">
...
&nbsp; </strong><?php echo $row_sinav['bast']; ?> </td>
             </tr>
             <tr class="icyazi">
               <td><div align="right"><strong>Bitiþ Tarihi </strong></div></td>
               <td><div align="center"><strong>:</strong></div></td>
               <td><input name="bitistarih" type="text" class="icyazi" id="bitistarih" value="<?php echo $row_sinav['bitistarih']; ?>" size="15">
                 <script language="JavaScript" type="text/javascript">
        		function calendar2Callback(date, month, year)
                 ...
                 </script> &nbsp; <?php echo $row_sinav['bitt']; ?></td>
             </tr>
             <tr class="icyazi">
               ...
               <td><select name="sinavsaat" class="icyazi" id="sinavsaat">
                 <option value="<?php echo $row_sinav['sinavsaat']; ?>" selected>Deðiþiklik Yok</option>
                 <option>09:00</option>
                 <option>09:30</option>
                 <option>10:00</option>
                 <option>10:30</option>
                 ...
                 <option>21:30</option>
                 <option>22:00</option>
                                                                                          </select>                    <?php echo $row_sinav['sinavsaat']; ?><span class="formaciklama"> (Sadece Merkezde Yüzyüze yapýlan sýnavlarda saat belirtiniz.)</span></td>
             </tr>
             <tr class="icyazi">
               <td valign="top"><div align="right"><strong>Açýklama</strong></div></td>
               <td valign="top"><div align="center"><strong>:</strong></div></td>
               <td><textarea name="aciklama" cols="50" rows="5" class="icyazi" id="aciklama"><?php echo $row_sinav['aciklama']; ?></textarea></td>
             </tr>
             <tr class="icyazi">
               <td valign="top"><div align="right">
                 <input name="snvtrhno" type="hidden" id="snvtrhno" value="<?php echo $row_sinav['snvtrhno']; ?>">
                 <input name="subeno" type="hidden" id="subeno" value="<?php echo $row_sinav['subeno']; ?>">
               </div></td>
               <td valign="top">&nbsp;</td>
               <td><input name="Submit" type="submit" class="butongiris" onClick="YY_checkform('form1','baslamatarih','#q','0','Sohbet saatlerinin baþlama tarihini giriniz.','bitistarih','#q','0','Sohbet saatlerinin bitiþ tarihini giriniz.');return document.MM_returnValue" value="Sýnav Bilgilerini Güncelle"></td>
             </tr>
           </table>
