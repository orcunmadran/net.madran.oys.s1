...
if ((isset($_GET['duyuruno'])) && ($_GET['duyuruno'] != "")) {
  $deleteSQL = sprintf("DELETE FROM duyurular WHERE duyuruno=%s",
  ...
  $deleteGoTo = "islemler.php?bilgi= > Kayýt baþarýyla silindi";
  ...
  <tr><!-- row 3 -->
   ...
   <td colspan="14" valign="top" bgcolor="#FFFFFF"><!-- InstanceBeginEditable name="icerik" -->
     <table width="100%"  border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="70%" class="formaciklama">Kayýt Siliniyor...</td>
         <td width="30%">&nbsp;</td>
       </tr>
     </table>
