  ...
  <tr><!-- row 3 -->
   ...
   <td colspan="14" valign="top" bgcolor="#FFFFFF"><!-- InstanceBeginEditable name="icerik" -->
     <table width="100%"  border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="70%" class="baslik">Duyurular</td>
         <td width="30%" rowspan="4"><div align="right" class="arabaslik">
           <table width="100%"  border="0" cellspacing="5" cellpadding="0">
             ...
             <tr>
               <td><div align="right">
                 <p><a href="ekle.php" class="icyazi">Duyuru Ekle</a></p>
                 </div></td>
             </tr>
             <tr>
               <td><div align="right" class="icyazi"><a href="islemler.php">Duyuru Güncelle / Sil</a></div></td>
             </tr>
             <tr>
       ...
       <tr>
         <td><span class="altbaslik">Sað bölümde bulunan menü yardýmý ile Duyuru iþlemlerini gerçekleþtirebilirsiniz.</span></td>
        </tr>
       <tr>
         <td>&nbsp;</td>
        </tr>
