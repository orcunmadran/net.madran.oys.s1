...
mysql_select_db($database_iysconn, $iysconn);
$query_mesajlar = sprintf("SELECT *, DATE_FORMAT(tarihsaat, '%%d.%%m.%%y - %%H:%%i') AS ts FROM mesajlar WHERE gonderen = '%s' ORDER BY tarihsaat DESC", $colname_mesajlar);
  ...
  <tr><!-- row 3 -->
   ...
   <td colspan="14" valign="top" bgcolor="#FFFFFF"><!-- InstanceBeginEditable name="icerik" -->
     <table width="100%"  border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td colspan="3" class="baslik"><span class="arabaslikuyari"><?php echo $_GET['kadi'] ?></span> kullanýcýsýnýn attýðý tüm mesajlar </td>
       </tr>
       <tr>
         <td width="24%" class="icyazi"><strong>Toplam Mesaj Sayýsý: </strong><span class="icyaziuyari"><?php echo $totalRows_mesajlar?></span></td>
         <td width="49%" class="icyazi"><span class="icyaziuyari"><?php echo $_GET['bilgi']?></span>&nbsp;</td>
         <td width="27%" class="icyazi"><div align="right"><a href="javascript:history.back()">Kullanýcý Bilgilerine geri dön</a> </div></td>
       </tr>
       <tr>
