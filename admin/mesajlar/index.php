...
mysql_select_db($database_iysconn, $iysconn);
$query_msayi = "SELECT *, DATE_FORMAT(tarihsaat, '%d.%m.%y - %H:%i') AS ts FROM mesajlar ORDER BY tarihsaat DESC";
$msayi = mysql_query($query_msayi, $iysconn) or die(mysql_error());
$row_msayi = mysql_fetch_assoc($msayi);
$totalRows_msayi = mysql_num_rows($msayi);

mysql_select_db($database_iysconn, $iysconn);
$query_masayi = "SELECT * FROM mesajlar WHERE okundu = '0'";
$masayi = mysql_query($query_masayi, $iysconn) or die(mysql_error());
$row_masayi = mysql_fetch_assoc($masayi);
$totalRows_masayi = mysql_num_rows($masayi);
?>
...
<!-- Shim row, height 1. -->
  ...
  <tr><!-- row 2 -->
   ...
   <td><a href="index.php" onMouseOut="MM_swapImgRestore();" onMouseOver="MM_swapImage('admin_r2_c6','','../fw_admin/admin_r2_c6_f2.gif',1)"><img name="admin_r2_c6" src="../fw_admin/admin_r2_c6.gif" width="73" height="25" border="0" alt="Mesajlarý denetle"></a></td>
  ...
  <tr><!-- row 3 -->
   ...
   <td colspan="14" valign="top" bgcolor="#FFFFFF"><!-- InstanceBeginEditable name="icerik" -->
     <table width="100%"  border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="70%" height="32" class="baslik">Mesajlar Paneline Hoþgeldiniz. </td>
         <td width="30%" rowspan="4" valign="top"><table width="100%"  border="0" cellspacing="5" cellpadding="5">
           <tr>
             <td colspan="3"><div align="center" class="arabaslik">
               <div align="right">Mesaj Ýstatistikleri</div>
             </div></td>
           </tr>
           <tr>
             <td width="81%" class="icyazi"><div align="right"><strong>Toplam Mesaj Sayýsý </strong></div></td>
             <td width="7%" class="icyazi"><strong>:</strong></td>
             <td width="12%"><span class="icyaziuyari"><?php echo $totalRows_msayi?></span></td>
           </tr>
           <tr>
             <td class="icyazi"><div align="right"><strong>Okunmamýþ Mesaj Sayýsý</strong></div></td>
             <td class="icyazi"><strong>:</strong></td>
             <td><span class="icyaziuyari"><?php echo $totalRows_masayi?></span></td>
           </tr>
           <tr>
             <td colspan="3" nowrap><div align="center" class="icyazi">
               <div align="right">
                 <?php if ($totalRows_msayi > 0) { // Show if recordset not empty ?>
                 Son Mesaj <strong class="icyaziuyari"><?php echo $row_msayi['ts']; ?></strong> atýldý.
                 <?php } // Show if recordset not empty ?>
               </div>
             </div></td>
             </tr>
           <tr>
             <td colspan="3" nowrap><hr align="left" size="1"></td>
           </tr>
           <tr>
             <td colspan="3" nowrap class="arabaslik"><div align="right">Mesaj Ýþlemleri </div></td>
           </tr>
           <tr>
             <td colspan="3" nowrap class="arabaslik"><div align="right" class="icyazi"><a href="mesajlar.php">Sistemde yer alan tüm mesajlar </a></div></td>
           </tr>
           <tr>
             <td colspan="3" nowrap class="arabaslik">&nbsp;</td>
           </tr>
         </table></td>
       </tr>
       <tr>
       ...
       <tr>
         <td class="altbaslik">Sað bölümde bulunan menü yardýmý ile &quot;Mesajlar&quot; ile ilgili iþlemleri gerçekleþtirebilirsiniz.</td>
        </tr>
       <tr>
         <td valign="top" class="icyazi"><strong>Sistemde yer alan tüm mesajlar:</strong> Sistemde yer alan tüm mesajlarý görüntüler. Ýlgili mesajýn ayrýntýsýný görebilmeniz için gerekli olan baðlantýyý saðlar. </td>
        </tr>
     </table>
...
mysql_free_result($msayi);

mysql_free_result($masayi);
?>
