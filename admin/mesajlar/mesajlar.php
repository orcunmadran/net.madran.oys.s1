...
mysql_select_db($database_iysconn, $iysconn);
$query_mesajlar = "SELECT *, DATE_FORMAT(tarihsaat, '%d.%m.%y - %H:%i') AS ts FROM mesajlar ORDER BY tarihsaat DESC";
  ...
  <tr><!-- row 3 -->
   ...
   <td colspan="14" valign="top" bgcolor="#FFFFFF"><!-- InstanceBeginEditable name="icerik" -->
     <table width="100%"  border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td colspan="2" class="baslik">Sistemde Yer Alan Tüm Mesajlar </td>
       </tr>
       <tr>
         <td width="24%" class="icyazi"><strong>Toplam Mesaj Sayýsý: </strong><span class="icyaziuyari"><?php echo $totalRows_mesajlar?></span></td>
         <td width="76%" class="icyazi"><span class="icyaziuyari"><?php echo $_GET['bilgi']?></span>&nbsp;</td>
       </tr>
       <tr>
         <td colspan="2"><form method="POST" name="goster" id="goster">
