...
mysql_select_db($database_iysconn, $iysconn);
$query_mesajlar = sprintf("SELECT *, DATE_FORMAT(tarihsaat, '%%d.%%m.%%y - %%H:%%i') AS ts FROM mesajlar WHERE alici = '%s' ORDER BY tarihsaat DESC", $colname_mesajlar);
  ...
  <tr><!-- row 3 -->
   ...
   <td colspan="14" valign="top" bgcolor="#FFFFFF"><!-- InstanceBeginEditable name="icerik" -->
     <table width="100%"  border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td colspan="3" class="baslik"><span class="arabaslikuyari"><?php echo $_GET['kadi'] ?></span> kullanýcýsýnýn aldýðý tüm mesajlar </td>
       </tr>
       <tr>
