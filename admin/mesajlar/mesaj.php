...
if (isset($_GET['mesajno'])) {
  $colname_mesaj = (get_magic_quotes_gpc()) ? $_GET['mesajno'] : addslashes($_GET['mesajno']);
}
mysql_select_db($database_iysconn, $iysconn);
$query_mesaj = sprintf("SELECT *, DATE_FORMAT(tarihsaat, '%%d.%%m.%%y - %%H:%%i') AS ts FROM mesajlar WHERE mesajno = %s", $colname_mesaj);
  ...
  <tr><!-- row 3 -->
   ...
   <td colspan="14" valign="top" bgcolor="#FFFFFF"><!-- InstanceBeginEditable name="icerik" -->
     <table width="100%"  border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="70%" class="baslik">Mesaj</td>
         <td width="30%">&nbsp;</td>
       </tr>
       <tr>
         <td><form action="" method="post" name="sil" id="sil">
           <table width="100%"  border="0" cellspacing="5" cellpadding="0">
             <tr class="icyazi">
               <td width="54" class="icyazi"><div align="right"><strong>Kimden</strong></div></td>
               <td width="8" class="arabaslik"><div align="center">:</div></td>
             ...
             <tr class="icyazi">
               <td height="22" class="icyazi"><div align="right"><strong>Konu</strong></div></td>
               <td class="arabaslik"><div align="center">:</div></td>
               <td width="540" class="icyazi"><?php echo $row_mesaj['konu']; ?></td>
               <td width="16" class="icyazi"><a href="mesajsil.php?<?php echo $MM_keepURL; ?>"><img src="../../mesajlar/m_imaj/sil.gif" alt="Mesajý Sil" width="16" height="14" border="0"></a></td>
             </tr>
             <tr>
             ...
             <tr>
               ...
               <td class="icyazi">&nbsp;</td>
               <td colspan="2" class="icyazi"><textarea name="textarea" cols="75" rows="15" class="mesajoku"><?php echo $row_mesaj['icerik']; ?></textarea>
               </td>
             </tr>
           </table>
         </form>         <p>&nbsp;</p>
         </td>
         <td valign="top"><div align="left" class="icyaziblok">
           <div align="center" class="icyaziblok">
             <table width="100%"  border="0" cellspacing="5" cellpadding="5">
               <tr>
                 <td><div align="center"><span class="icyaziuyari">!!! UYARI !!!</span></div></td>
               </tr>
               <tr>
                 <td class="icyaziblok">Yönetim Panelinden silinen mesajlar veritabanýndan kalýcý olarak silinir. Bu iþlemin geri dönüþü bulunmamaktadýr.</td>
               </tr>
               <tr>
                 <td class="icyaziblok">&nbsp;</td>
               </tr>
               <tr>
                 <td class="icyaziblok">&nbsp;</td>
               </tr>
             </table>
             <p align="center" class="icyaziuyari">&nbsp;</p>
             <p align="center" class="icyaziuyari">&nbsp;</p>
             <p>&nbsp;</p>
                          <p>&nbsp;</p>
