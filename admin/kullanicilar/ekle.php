...
if (isset($_POST[$MM_flag])) {
  $MM_dupKeyRedirect="ekle.php?bilgi= > Bu kullanýcý adý ile zaten bir kayýt var";
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "ekle")) {
  $insertSQL = sprintf("INSERT INTO kullanici (ad, soyad, kadi, kadis, sifre, kategori, eposta, webadres, evadres, evtel, isadres, istel, mobiltel, aciklama) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString(strtr ($_POST['kadis'],"ÜÐÝÞÇÖüðýþçö","UGISCOugisco"), "text"),
  ...
  <tr><!-- row 3 -->
   ...
   <td colspan="14" valign="top" bgcolor="#FFFFFF"><!-- InstanceBeginEditable name="icerik" -->
     <table width="100%"  border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="70%" class="arabaslik">Yeni Kullanýcý Ekle  <span class="arabaslikuyari"></span></td>
         <td width="30%"><div align="center" class="arabaslik">Son Eklenen Kullanýcýlar </div></td>
       </tr>
       <tr>
         <td><form action="<?php echo $editFormAction; ?>" method="POST" name="ekle" id="ekle">
           <table width="100%"  border="0" cellspacing="5" cellpadding="0">
             ...
             <tr>
               <td class="icyazi"><div align="right"><strong>Kullanýcý Adý </strong></div></td>
               ...
               <td><input name="kadi" type="text" class="icyazi" id="kadi" size="45" maxlength="60"> 
                 <span class="baslik">*
                 <input name="Button" type="button" class="butongiris" onClick="MM_callJS('kaolustur()')" value="Oluþtur">
             ...
             <tr>
               <td>&nbsp;</td>
               <td>&nbsp;</td>
               <td><input name="Submit" type="submit" class="butongiris" onClick="YY_checkform('ekle','ad','#q','0','Ad alaný boþ býrakýlamaz','soyad','#q','0','Soyad alaný boþ býrakýlamaz','kadi','#q','0','Kullanýcý adýný tanýmlayýnýz','sifre','#q','0','Þifre oluþturunuz','eposta','#S','2','E - Posta adresi giriniz','kategori','#q','1','Kategorilerden biriniz seçiniz');return document.MM_returnValue" value="Yeni Kullanýcý Ekle"></td>
               </tr>
             <tr>
               <td>&nbsp;</td>
