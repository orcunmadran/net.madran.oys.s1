...
$deger_bp = "-1";
if (isset($_GET['kadi'])) {
  $deger_bp = (get_magic_quotes_gpc()) ? $_GET['kadi'] : addslashes($_GET['kadi']);
}
mysql_select_db($database_iysconn, $iysconn);
$query_bp = sprintf("SELECT ad, soyad, kadi, kadis, sifre, eposta FROM kullanici WHERE kadi = %s", GetSQLValueString($deger_bp, "text"));
$bp = mysql_query($query_bp, $iysconn) or die(mysql_error());
$row_bp = mysql_fetch_assoc($bp);
$totalRows_bp = mysql_num_rows($bp);
?>
  ...
  <tr><!-- row 3 -->
   ...
   <td colspan="14" valign="top" bgcolor="#FFFFFF"><!-- InstanceBeginEditable name="icerik" -->
     <table width="100%"  border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="70%" class="baslik">Kullanýcý Adý  ve Þifre Bilgilerini Postala</td>
         <td width="30%">&nbsp;</td>
       </tr>
       <tr>
         <td><form name="form1" method="post" action="bilgipostala_ok.php">
           <table width="100%"  border="0" cellspacing="5" cellpadding="5">
             <tr>
               <td colspan="3" class="arabaslik">Bilgi gönderilecek kullanýcýnýn:</td>
               </tr>
             <tr>
               <td width="36%" class="icyazi"><div align="right"><strong>Adý</strong></div></td>
               <td width="3%" class="icyazi"><strong>:</strong></td>
               <td width="61%" class="icyazi"><?php echo $row_bp['ad']; ?>
                 <input name="ad" type="hidden" id="ad" value="<?php echo $row_bp['ad']; ?>"></td>
             </tr>
             <tr>
               <td class="icyazi"><div align="right"><strong>Soyadý</strong></div></td>
               <td class="icyazi"><strong>:</strong></td>
               <td class="icyazi"><?php echo $row_bp['soyad']; ?>
                 <input name="soyad" type="hidden" id="soyad" value="<?php echo $row_bp['soyad']; ?>"></td>
             </tr>
             <tr>
               <td class="icyazi"><div align="right"><strong>E - Posta Adresi </strong></div></td>
               <td class="icyazi"><strong>:</strong></td>
               <td class="icyazi"><?php echo $row_bp['eposta']; ?>
                 <input name="eposta" type="hidden" id="eposta" value="<?php echo $row_bp['eposta']; ?>"></td>
             </tr>
             <tr>
               <td colspan="3" class="icyazi"><hr></td>
               </tr>
             <tr>
               <td class="icyazi"><div align="right"><strong>Sanal Kampüs Kullanýcý Adý </strong></div></td>
               <td class="icyazi"><strong>:</strong></td>
               <td class="icyazi"><?php echo $row_bp['kadi']; ?>
                 <input name="sk_kadi" type="hidden" id="sk_kadi" value="<?php echo $row_bp['kadi']; ?>"></td>
             </tr>
             <tr>
               <td class="icyazi"><div align="right"><strong>Sanal Kampüs Þifre </strong></div></td>
               <td class="icyazi"><strong>:</strong></td>
               <td class="icyazi"><?php echo $row_bp['sifre']; ?>
                 <input name="sk_sifre" type="hidden" id="sk_sifre" value="<?php echo $row_bp['sifre']; ?>"> </td>
             </tr>
             <tr>
               <td class="icyazi"><div align="right"><strong>Sohbet Sistemi Kullanýcý Adý </strong></div></td>
               <td class="icyazi"><strong>:</strong></td>
               <td class="icyazi"><?php echo $row_bp['kadis']; ?>
                 <input name="ss_kadi" type="hidden" id="ss_kadi" value="<?php echo $row_bp['kadis']; ?>"></td>
             </tr>
             <tr>
               <td class="icyazi"><div align="right"><strong>Sohbet Sistemi Þifre </strong></div></td>
               <td class="icyazi"><strong>:</strong></td>
               <td class="icyazi"><?php echo $row_bp['sifre']; ?>&nbsp;
                 <input name="ss_sifre" type="hidden" id="ss_sifre" value="<?php echo $row_bp['sifre']; ?>"></td>
             </tr>
             <tr>
               <td valign="top" class="icyazi"><div align="right"><strong>Mesaj</strong></div></td>
               <td valign="top" class="icyazi"><strong>:</strong></td>
               <td class="icyazi"><textarea name="mesaj" cols="50" rows="5" class="icyazi" id="mesaj">Sayýn <?php echo $row_bp['kadi']; ?>,

Kullanýcý adý ve þifre bilgileriniz aþaðýda yer almaktadýr.
</textarea></td>
             </tr>
             <tr>
               <td valign="top" class="icyazi">&nbsp;</td>
               <td valign="top" class="icyazi">&nbsp;</td>
               <td class="icyazi"><input name="Submit" type="submit" class="butongiris" value="E - Postayý Yolla"></td>
             </tr>
           </table>
         </form></td>
         <td>&nbsp;</td>
