  ...
  <tr><!-- row 3 -->
   ...
   <td colspan="14" valign="top" bgcolor="#FFFFFF"><!-- InstanceBeginEditable name="icerik" -->
     <table width="100%"  border="0" cellspacing="5" cellpadding="5">
       ...
       <tr>
         <td colspan="7" class="altbaslik">Toplam <strong><?php echo $totalRows_tamliste ?></strong> kullanýcý. (<strong><?php echo ($startRow_tamliste + 1) ?></strong> - <strong><?php echo min($startRow_tamliste + $maxRows_tamliste, $totalRows_tamliste) ?></strong> arasý gösteriliyor.)</td>
        </tr>
       <tr>
         <td width="13%" class="icyazi"><strong><a href="<?php echo getSortLink('tamliste','ad'); ?>">Adý </a><?php echo getSortIcon('tamliste','ad'); ?></strong></td>
         <td width="12%" class="icyazi"><strong><a href="<?php echo getSortLink('tamliste','soyad'); ?>">Soyadý </a><?php echo getSortIcon('tamliste','soyad'); ?></strong></td>
         <td width="16%" class="icyazi"><strong><a href="<?php echo getSortLink('tamliste','kadi'); ?>">Kullanýcý Adý </a><?php echo getSortIcon('tamliste','kadi'); ?></strong></td>
         <td width="12%" class="icyazi"><strong><a href="<?php echo getSortLink('tamliste','sifre'); ?>">Þifre</a> <?php echo getSortIcon('tamliste','sifre'); ?></strong></td>
