...
$deger_detay = "-1";
if (isset($_GET['kadi'])) {
  $deger_detay = (get_magic_quotes_gpc()) ? $_GET['kadi'] : addslashes($_GET['kadi']);
}
mysql_select_db($database_iysconn, $iysconn);
$query_detay = sprintf("SELECT *, DATE_FORMAT(giriszaman, '%%d.%%m.%%y - %%H:%%i') AS gzf FROM kullanici WHERE kadi ='%s'", $deger_detay);
$detay = mysql_query($query_detay, $iysconn) or die(mysql_error());
  ...
  <tr><!-- row 3 -->
   ...
   <td colspan="14" valign="top" bgcolor="#FFFFFF"><!-- InstanceBeginEditable name="icerik" -->
     <table width="100%"  border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td colspan="3" class="arabaslik">Kullanýcý Detay Bilgileri </td>
         <td>&nbsp;</td>
       </tr>
       <tr>
         <td width="22%" valign="top" class="icyazi"><div align="right"><strong>Adý</strong></div></td>
         <td width="2%" valign="top" class="icyazi"><div align="center"><strong>:</strong></div></td>
         <td width="46%" valign="top" class="icyazi"><?php echo $row_detay['ad']; ?></td>
         <td width="30%"><div align="center" class="arabaslik">
           <div align="left">Kullanýcý Ýþlemleri:</div>
         </div></td>
       </tr>
       <tr>
         ...
         <td valign="top" class="icyazi"><?php echo $row_detay['soyad']; ?></td>
         <td class="icyazi"><div align="left"><a href="guncelleb.php?<?php echo $MM_keepURL; ?>">Bilgileri güncelle</a></div></td>
       </tr>
       <tr>
         <td valign="top" class="icyazi"><div align="right"><strong>Kullanýcý Adý </strong></div></td>
         <td valign="top" class="icyazi"><div align="center"><strong>:</strong></div></td>
         <td valign="top" class="icyazi"><?php echo $row_detay['kadi']; ?></td>
         <td class="icyazi"><div align="left"><a href="silb.php?<?php echo $MM_keepURL; ?>">Kaydý sil</a></div></td>
       </tr>
       <tr>
         <td valign="top" class="icyazi"><div align="right"><strong>Þifre</strong></div></td>
         <td valign="top" class="icyazi">:</td>
         <td valign="top" class="icyazi"><?php echo $row_detay['sifre']; ?></td>
         <td class="icyazi"><div align="left">Aldýðý dersleri gör </div></td>
       </tr>
       <tr>
         <td valign="top" class="icyazi"><div align="right"><strong>Kategori</strong></div></td>
         <td valign="top" class="icyazi"><div align="center"><strong>:</strong></div></td>
         <td valign="top" class="icyazi"><?php echo $row_detay['kategori']; ?></td>
         <td class="icyazi"><div align="left"><a href="../mesajlar/mesajlaratilan.php?<?php echo $MM_keepURL; ?>">Attýðý mesajlarý gör</a> </div></td>
       </tr>
       <tr>
         <td valign="top" class="icyazi"><div align="right"><strong>E - Posta</strong></div></td>
         <td valign="top" class="icyazi"><div align="center"><strong>:</strong></div></td>
         <td valign="top" class="icyazi"><a href="mailto:<?php echo $row_detay['eposta']; ?>"><?php echo $row_detay['eposta']; ?></a></td>
         <td><a href="../mesajlar/mesajlaralinan.php?<?php echo $MM_keepURL; ?>" class="icyazi"> Aldýðý mesajlarý gör 
           </a></td>
       </tr>
       <tr>
         <td valign="top" class="icyazi"><div align="right"><strong>Web Adres </strong></div></td>
         <td valign="top" class="icyazi"><div align="center"><strong>:</strong></div></td>
         <td valign="top" class="icyazi"><a href="<?php echo $row_detay['webadres']; ?>" target="_blank"><?php echo $row_detay['webadres']; ?></a></td>
         <td><div align="left" class="icyazi"><a href="../mesajlar/mesajlaraa.php?<?php echo $MM_keepURL; ?>">Attýðý ve aldýðý mesajlarý birlikte gör</a> </div></td>
       </tr>
       <tr>
         <td valign="top" class="icyazi"><div align="right"><strong>Ev Adres </strong></div></td>
         <td valign="top" class="icyazi"><div align="center"><strong>:</strong></div></td>
         <td valign="top" class="icyazi"><?php echo $row_detay['evadres']; ?></td>
         <td><div align="left"><span class="icyazi">Tartýþma gruplarýndaki mesajlarýný gör </span></div></td>
       </tr>
       <tr>
         <td valign="top" class="icyazi"><div align="right"><strong>Ev Tel </strong></div></td>
         <td valign="top" class="icyazi"><div align="center"><strong>:</strong></div></td>
         <td valign="top" class="icyazi"><?php echo $row_detay['evtel']; ?></td>
         <td><div align="left" class="icyazi"><a href="bilgipostala.php?<?php echo $MM_keepURL; ?>">Kullanýcý ve þifre bilgilerini postala</a></div></td>
       </tr>
       <tr>
         <td valign="top" class="icyazi"><div align="right"><strong>Ýþ Adres </strong></div></td>
         <td valign="top" class="icyazi"><div align="center"><strong>:</strong></div></td>
         <td valign="top" class="icyazi"><?php echo $row_detay['isadres']; ?></td>
         <td><div align="left"></div></td>
       </tr>
       <tr>
         <td valign="top" class="icyazi"><div align="right"><strong>Ýs Tel </strong></div></td>
         <td valign="top" class="icyazi"><div align="center"><strong>:</strong></div></td>
         <td valign="top" class="icyazi"><?php echo $row_detay['istel']; ?></td>
         <td><div align="left"></div></td>
       </tr>
       <tr>
         <td valign="top" class="icyazi"><div align="right"><strong>Mobil</strong></div></td>
         <td valign="top" class="icyazi"><div align="center"><strong>:</strong></div></td>
         <td valign="top" class="icyazi"><?php echo $row_detay['mobiltel']; ?></td>
         <td><div align="left"></div></td>
       </tr>
       <tr>
         <td valign="top" class="icyazi"><div align="right"><strong>Açýklama</strong></div></td>
         <td valign="top" class="icyazi"><div align="center"><strong>:</strong></div></td>
         <td valign="top" class="icyazi"><?php echo $row_detay['aciklama']; ?></td>
         <td><div align="left">
           <hr>
         </div></td>
       </tr>
       <tr>
         <td valign="top" class="icyazi"><div align="right"><strong>Sisteme Kayýt Tarihi </strong></div></td>
         <td valign="top" class="icyazi"><strong>:</strong></td>
         <td valign="top" class="icyazi">
			<?php echo $row_detay['gzf'];?>
		 </td>
         <td><a href="javascript:history.back()" class="icyazi">Listeye geri dönmek istiyorum</a></td>
       </tr>
     </table>
