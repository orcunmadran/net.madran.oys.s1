...
<?php
			$kime1 = $_POST['eposta'];
			$kime2 = "omadran@baskent.edu.tr";
			$postaeks = "From: Sanal Kampüs Yönetimi <bote@baskent.edu.tr>";
			$kimden = "bote@baskent.edu.tr";
			$subject="Sanal Kampüs ve Sohbet Sistemi kullanýcý adý ve þifreleri.";
			$mailcontent=
			$_POST['mesaj']."\n".
			"Sanal Kampüs Kullanýcý Adý: ".$_POST['sk_kadi']."\n".
			"Sanal Kampüs Þifre: ".$_POST['sk_sifre']."\n".
			"Sohbet Sistemi Kullanýcý Adý: ".$_POST['ss_kadi']."\n".
			"Sohbet Sistemi Þifre: ".$_POST['ss_sifre']."\n";
			
			mail($kime1, $subject, $mailcontent, $postaeks);
			mail($kime2, $subject, $mailcontent, $postaeks);
?>
  ...
  <tr><!-- row 3 -->
   ...
   <td colspan="14" valign="top" bgcolor="#FFFFFF"><!-- InstanceBeginEditable name="icerik" -->
     <table width="100%"  border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="70%"><span class="baslik">Kullanýcý Adý ve Þifre Bilgilerini Postala</span><span class="baslik">&gt;</span> <span class="baslikuyari">Postalandý</span></td>
         <td width="30%">&nbsp;</td>
       </tr>
       <tr>
         <td class="arabaslik">Bilgiler kullanýcýya gönderildi. </td>
         <td>&nbsp;</td>
       </tr>
       <tr>
         <td class="icyazi">Kullanýcý listesine ulaþmak için <a href="tamliste.php">týklayýnýz</a>.</td>
         <td>&nbsp;</td>
       </tr>
       <tr>
         <td class="icyazi">Yeni bir kullanýcý girmek için <a href="ekle.php">týklayýnýz</a>. </td>
         <td>&nbsp;</td>
       </tr>
     </table>
