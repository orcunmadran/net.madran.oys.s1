...
$colname_sil = "-1";
if (isset($_GET['kadi'])) {
  $colname_sil = (get_magic_quotes_gpc()) ? $_GET['kadi'] : addslashes($_GET['kadi']);
}
mysql_select_db($database_iysconn, $iysconn);
$query_sil = sprintf("SELECT kadi FROM kullanici WHERE kadi = '%s'", $colname_sil);
$sil = mysql_query($query_sil, $iysconn) or die(mysql_error());
$row_sil = mysql_fetch_assoc($sil);
$totalRows_sil = mysql_num_rows($sil);
  ...
  <tr><!-- row 3 -->
   ...
   <td colspan="14" valign="top" bgcolor="#FFFFFF"><!-- InstanceBeginEditable name="icerik" -->
     <table width="100%"  border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="70%"><span class="arabaslik">Kayýt Sil Onay </span></td>
         <td width="30%">&nbsp;</td>
       </tr>
       <tr>
         <td><span class="altbaslik">Aþaðýda yer alan kullanýcýyý silmek istiyormusunuz?</span></td>
         <td>&nbsp;</td>
       </tr>
       <tr>
         <td height="45" class="icyazi"><form name="form1" action="">
           <p><strong>Kullanýcý Adý:</strong> <?php echo $row_sil['kadi']; ?> </p>
           <p class="icyazi"><a href="silc.php?<?php echo $MM_keepURL; ?>">Evet kullanýcýyý sistemden tamamen silmek istiyorum.</a></p>
           <p class="icyazi"><a href="javascript:history.back()">Hayýr önceki ekrana geri dönmek istiyorum.</a><a href="javascript:history.back()"> </a></p>
         </form>           </td>
         <td>&nbsp;</td>
       </tr>
     </table>
