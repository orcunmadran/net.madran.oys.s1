...
if ((isset($_GET['kadi'])) && ($_GET['kadi'] != "")) {
  $deleteSQL = sprintf("DELETE FROM kullanici WHERE kadi=%s",
                       GetSQLValueString($_GET['kadi'], "text"));

  mysql_select_db($database_iysconn, $iysconn);
  $Result1 = mysql_query($deleteSQL, $iysconn) or die(mysql_error());

  $deleteGoTo = "sila.php?bilgi= > Kayýt baþarýyla silinmiþtir";
...
mysql_select_db($database_iysconn, $iysconn);
$query_sil = "SELECT kadi FROM kullanici";
  ...
  <tr><!-- row 3 -->
   ...
   <td colspan="14" valign="top" bgcolor="#FFFFFF"><!-- InstanceBeginEditable name="icerik" -->
     <table width="100%"  border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td colspan="2" class="formaciklama">Kayýt Siliniyor...</td>
        </tr>
     </table>
