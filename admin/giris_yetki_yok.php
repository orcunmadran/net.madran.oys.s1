...
<!-- Shim row, height 1. -->
  ...
  <tr><!-- row 3 -->
   ...
   <td bgcolor="#FFFFFF">     <p align="center" class="baslik style1">Yetkiniz Yok !!! </p>     <p align="center" class="arabaslik">Ulaşmak istediğiniz <br>
        sayfalar yetkiniz dışındadır.</p>     
     <p align="center" class="altbaslik">Yeniden giriş 
    yapmak için <a href="index.php">tıklayınız</a>.</p></td>
...
<p align="center"><span class="copyright">&copy; 2006 - Bilgisayar ve Öğretim Teknolojileri Eğitimi Bölümü</span></p>
</body>
</html>
