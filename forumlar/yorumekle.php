...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "yorumla")) {
  $insertSQL = sprintf("INSERT INTO tg_yorumlar (baslikno, yorum, yazar) VALUES (%s, %s, %s)",
...
<table width="100%"  border="0" cellspacing="5" cellpadding="5">
       <tr valign="middle">
         <td class="icyazi"><span class="baslik"> </span><span class="baslik">Yorum Ekle</span></td>
         <td class="icyazi">&nbsp;</td>
       </tr>
       <tr class="arabaslik">
         <td class="icyazi"><p class="arabaslik"><a href="forumlar.php">Forumlar</a> &gt; <a href="javascript:history.back()"><?php echo $row_baslikgor['adi']; ?></a> &gt; <?php echo $row_baslikgor['baslik']; ?> </p>           </td>
         <td class="icyazi">&nbsp;</td>
       </tr>
       <tr>
         <td class="icyazi"><form action="<?php echo $editFormAction; ?>" method="POST" name="yorumla" id="yorumla">
           <table width="100%"  border="0" cellpadding="5" cellspacing="5" bgcolor="#999999">
             ...
             <tr class="icyazi">
               ...
               <td width="85%"><textarea name="yorum" cols="75" rows="15" class="icyazi" id="yorum"></textarea></td>
             </tr>
             <tr>
               <td><div align="right">
                 <input name="yazar" type="hidden" id="yazar" value="<?php echo $row_gk['kadi']; ?>">
                 <input name="baslikno" type="hidden" id="baslikno" value="<?php echo $row_baslikgor['baslikno']; ?>">
               </div></td>
               <td>&nbsp;</td>
               <td><input name="Submit" type="submit" class="butongiris" onClick="MM_validateForm('yorum','','R');return document.MM_returnValue" value="Yorum Ekle"></td>
             </tr>
             <tr>
               <td>&nbsp;</td>
               <td>&nbsp;</td>
           ...
           <input type="hidden" name="MM_insert" value="yorumla">
         </form>
          </td>
