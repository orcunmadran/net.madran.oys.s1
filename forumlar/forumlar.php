...
mysql_select_db($database_iysconn, $iysconn);
$query_sk = "SELECT * FROM tg_forumlar WHERE tip = 'Serbest Kürsü' AND aktif = 'Evet' ORDER BY adi ASC";
  ...
  <tr><!-- row 3 -->
   ...
   <td colspan="18" valign="top" bgcolor="#FFFFFF"><!-- InstanceBeginEditable name="icerik" -->
     <table width="100%"  border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="67%" class="icyazi"><span class="baslik">Tartýþma Gruplarýna Hoþgeldin</span></td>
         <td width="3%" class="icyazi"><p class="baslik">&nbsp;</p></td>
         <td width="30%" class="icyazi">&nbsp;</td>
       </tr>
       <tr>
         <td><span class="altbaslik">Sanal Kampüs'te iki farklý tartýþma grubumuz var. Bu gruplar;</span> <span class="arabaslik">&quot;Ders Forumlarý&quot;</span> <span class="altbaslik">ve</span> <span class="arabaslik">&quot;Serbest Kürsü&quot;</span><span class="altbaslik">'dür.
           </span>
           <p class="icyazi">Ders Forumlarý'nda ders ile ilgili olarak ders sorumlusu tarafýndan oluþturulmuþ forum baþlýklarý altýnda konularý tartýþabiliyoruz.</p>
          <p class="icyazi">Serbest Kürsü'de ise &quot;Tartýþma Gruplarý&quot; kurallarý çerçevesinde istediðimiz konu hakkýnda kullanýcýlar ile fikir ve bilgi alýþveriþinde bulunabiliyoruz.</p></td>
         <td><p class="arabaslik">&nbsp;</p>
          </td>
         <td rowspan="3" valign="top" class="icyazi"><div align="center">
           <p align="left" class="arabaslik"><strong>Tartýþma Gruplarý Genel Kurallarý </strong></p>
           <p align="left" class=formaciklama>Tartýþma gruplarýnda yer alan forumlara yazýlan yorumlarýn tüm sorumluluðu yazarýna aittir. Tartýþma gruplarýnýn genel amaçlarý dýþýnda, kamu düzenini bozucu, genel ahlaka aykýrý yazýlar Sanal Kampüs yöneticileri tarafýndan silinecektir.</p>
           <p align="left" class=formaciklama>Tartýþma gruplarý genelinde bu tür davranýþlardan kaçýnýlmalý, karþýlaþýldýðý takdirde Sanal Kampüs yöneticiler bilgilendirilmelidir.</p>
           <p align="left" class=formaciklama><strong>Sanal Kampüs Yöneticisi </strong></p>
         </div></td>
       </tr>
       <tr>
         <td><hr></td>
       ...
       <tr>
         <td bgcolor="#999999"><p><span class="arabasfpB">Ders Forumlarý</span></p>
           <table width="100%"  border="0" cellpadding="0" cellspacing="5" bgcolor="#CCCCCC">
           <tr class="icyazi">
             <td width="27%"><strong>Ders Kodu </strong></td>
             <td width="42%"><strong>Açýklama</strong></td>
             <td width="31%"><strong>Forum Yöneticisi </strong></td>
           </tr>
           <tr class="icyazi">
...
<?php } // Show if recordset empty ?></td>
          ...
          <P class=icyazi><span class="arabasfpB">Serbest Kürsü</span></P>           
          <table width="100%"  border="0" cellpadding="0" cellspacing="5" bgcolor="#CCCCCC">
            <tr class="icyazi">
