...
?>
<?PHP
			$subject="Sanal Kampüsten yollanan bir mesaj var.";
			$mailcontent=
			"Mesaji Gönderen: ".$kadi."\n".
			"Ýlgili Birim: "." ".$birim."\n".
			"Konu: "." ".$konu."\n".
			"Mesaj: ".$mesaj."\n" ;
			
			mail($kime, $subject, $mailcontent, "From: $kadi\n");         
  ?>
  ...
  <tr><!-- row 3 -->
   ...
   <td colspan="18" valign="top" bgcolor="#FFFFFF"><!-- InstanceBeginEditable name="icerik" -->
     <table width="100%"  border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="70%" class="icyazi"><p class="baslik">Mesajýnýz Ýletildi</p></td>
         <td width="30%" class="icyazi">&nbsp;</td>
       </tr>
       <tr>
         <td class="arabaslik">Size en kýsa zamanda &quot;<a href="mesajlar/mesajlar.php">Mesaj</a>&quot; sistemi içerisinden yanýt verilecektir. </td>
         <td class="icyazi">&nbsp;</td>
       </tr>
     </table>
