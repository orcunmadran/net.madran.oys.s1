  ...
  <tr><!-- row 3 -->
   ...
   <td colspan="18" valign="top" bgcolor="#FFFFFF"><!-- InstanceBeginEditable name="icerik" -->
     <table width="100%"  border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="70%" class="icyazi"><p class="baslik">Sohbet Odalarý</p></td>
         <td width="30%" class="icyazi">&nbsp;</td>
       </tr>
       <tr>
         <td class="arabaslik">Sanal Kampüs Sohbet Odalarýna hoþgeldin</td>
         <td class="icyazi"><div align="center"><span class="arabaslikuyari">!!! Sisteme Giriþ Yaparken !!! </span></div></td>
       </tr>
       <tr>
         <td valign="top" class="icyazi"><p>Sohbet Odalarý, Sanal Kampüs içerisinde Öðretim Elemanlarý ve Öðrenciler ile canlý olarak sohbet edebileceðin bir platformdur. Bu platformda hem derslerin ile ilgili hem de genel kampüs yaþantýsýyla ilgili sohbetler yapabilirsin.</p>
          <p>Her dersin kendine ait bir sohbet saati bulunmaktadýr. Bu sohbet saatinde ders sorumlusu ile birlikte ders iþleme olanaðýna sahip olacaksýn. Ders saatleri dýþýnda da genel kullanýma açýk odalarda kampüs kullanýcýlarý ile sohbet etmen mümkün olacak.</p>
          <p class="arabaslik">Sohbet Odalarý ile ilgili dikkat edilmesi gerekenler:</p>
          <ul>
            <li>Sohbet Odalarýnda  yazýlan yorumlarýn tüm sorumluluðu yazarýna aittir. Sohbet Odalarýnýn genel amaçlarý dýþýnda, kamu düzenini bozucu, genel ahlaka aykýrý yazýlar tespit edildiðinde Sanal Kampüs yöneticileri tarafýndan gerekli iþlem yapýlacaktýr.</li>
            <li>Sohbet sisteminden çýkarken, sistemin sað üst bölümünde yer alan çýkýþ <img src="resimler/scikis.gif" width="27" height="26"> butonu kullanýlarak çýkýþ yapýlmazsa -direkt tarayýcý kapatýlýrsa- sohbet sistemine 120 saniye süreyle giriþ yapýlamaz.</li>
            </ul>
          <p align="center">
            <br>
            <input name="Submit" type="submit" class="butongiris" onClick="MM_openBrWindow('sohbet/flashchat.php','','resizable=yes,width=900,height=600')" value="Sohbet Odalarýna Giriþ Yap">
          </p></td>
         <td valign="top" class="icyazi"><p>Sohbet odalarýna giriþ yaparken kullanýcý adýnýzda türkçe karakter <strong>kullanmamanýz</strong> gerekmektedir.</p>
           <p>Sisteme giriþinizi lütfen aþaðýdaki örnekteki gibi yapýnýz;</p>
           <table width="100%"  border="0" cellspacing="5" cellpadding="0">
             <tr class="icyazi">
               <td width="35%"><div align="right"><strong>Kullanýcý Adý </strong></div></td>
               <td width="6%"><div align="center"><strong>:</strong></div></td>
               <td width="59%">Iþýl Çaðlayan Öztürk </td>
             </tr>
             <tr class="icyazi">
