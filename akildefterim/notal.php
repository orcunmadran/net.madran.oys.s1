...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "kaydet")) {
  $insertSQL = sprintf("INSERT INTO akildefterim (kadi, `not`, giristarih, hatirlat) VALUES (%s, %s, %s, %s)",
  ...
  <tr><!-- row 3 -->
   ...
   <td colspan="18" valign="top" bgcolor="#FFFFFF"><!-- InstanceBeginEditable name="icerik" -->
    ...
    //-->
             ...
             <tr>
               <td><div align="right">
                   <input name="giristarih" type="hidden" id="giristarih" value="<?php echo date('d.m.y - H:i') ?>">
                   <input name="kadi" type="hidden" id="kadi" value="<?php echo $row_gk['kadi']; ?>">
               </div></td>
               <td>&nbsp;</td>
               <td><input name="Submit" type="submit" class="butongiris" onClick="MM_callJS('d')" value="Notu Akýl Defterime Kaydet"></td>
             </tr>
           </table>
             <p><input type="hidden" name="MM_insert" value="kaydet">
             </p>
             </form>         
