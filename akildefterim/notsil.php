...
if ((isset($_GET['adno'])) && ($_GET['adno'] != "")) {
  $deleteSQL = sprintf("DELETE FROM akildefterim WHERE adno=%s",
                       GetSQLValueString($_GET['adno'], "int"));

  mysql_select_db($database_iysconn, $iysconn);
  $Result1 = mysql_query($deleteSQL, $iysconn) or die(mysql_error());

  $deleteGoTo = "yapacaklarim.php";
  ...
  <tr><!-- row 3 -->
   ...
   <td colspan="18" valign="top" bgcolor="#FFFFFF"><!-- InstanceBeginEditable name="icerik" -->
     <table width="100%"  border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="70%" class="icyazi"><p class="formaciklama">Kayýt Siliniyor...</p></td>
