  ...
  <tr><!-- row 3 -->
   ...
   <td colspan="18" valign="top" bgcolor="#FFFFFF"><!-- InstanceBeginEditable name="icerik" -->
     <table width="100%"  border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="70%" height="28" class="icyazi"><p class="baslik">Yardým </p></td>
         <td width="30%" class="icyazi"><div align="center"></div></td>
       </tr>
       <tr>
         <td class="arabaslik">Yardým bölümünün içeriði hazýrlanmaktadýr.</td>
         <td width="30%" class="icyazi">&nbsp;</td>
       </tr>
       <tr>
         <td class="icyazi">Ýçerik tamamlanýncaya kadar <a href="iletisim.php">iletiþim</a> bölümündeki formlar yardýmýyla sorunlarýnýzý aktarabilirsiniz.</td>
         <td width="30%" class="icyazi">&nbsp;</td>
       </tr>
     </table>
