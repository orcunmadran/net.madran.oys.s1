  ...
  <tr><!-- row 3 -->
   ...
   <td colspan="18" valign="top" bgcolor="#FFFFFF"><!-- InstanceBeginEditable name="icerik" -->
     <table width="100%"  border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="619" height="28" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="5">
           <tr>
             <td><span class="baslik">Sanal Kampüs'e Hoþgeldin,</span></td>
             </tr>
           <tr>
             <td><p class="arabaslik">Kontrolün tamamen sende olduðu bir öðrenim sürecine hazýr mýsýn?</p>
               <p class="altbaslik">Ýstediðin zaman derse girebilir, istediðin zaman arkadaþlarýnla ya da ders sorumlusu ile mesajlaþabilir, ödevlerini, projelerini sistem üzerinden takip edebilir, sýnavlarýna belirlenen süre içerisinde istediðin zaman girebilirsin.</p></td>
             </tr>
           <tr>
             <td class="arabaslik"><div align="left">
               <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="580" height="280">
                 <param name="movie" value="mantarpano.swf">
                 <param name=quality value=high>
                 <embed src="mantarpano.swf" quality=high pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="580" height="280"></embed>
               </object>
             </div></td>
           </tr>
           <tr>
             <td class="icyazi"><div align="center">Sanal Kampüs içerisindeki animasyon ve videolarý görüntüleyebilmeniz için <STRONG>FlashPlayer</STRONG> eklentisinin son sürümünün bilgisayarýnýza yüklenmiþ olmasý gerekmektedir.<BR>               
                   <A 
href="http://www.macromedia.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" 
target=_blank>Bu ücretsiz eklentiyi yüklemek için týklayýnýz.</A></div></td>
           </tr>
         </table>         
         </td>
