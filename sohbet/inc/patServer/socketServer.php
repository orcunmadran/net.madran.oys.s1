...
*/
	...
	function saveClientConnection( $clientId, $data )
	{
		...
		if($data['id'] != null) $this->clientInfo['connid'][$data['id']] = $clientId;
		if($data['userid'] != null) $this->clientInfo['userid'][$data['userid']] = $clientId;
		if($data['roomid'] != null) 
		{
			if(!is_array($this->clientInfo['roomid'][$data['roomid']])) $this->clientInfo['roomid'][$data['roomid']] = array();
			$this->clientInfo['roomid'][$data['roomid']][$clientId] = $clientId;
		}	
