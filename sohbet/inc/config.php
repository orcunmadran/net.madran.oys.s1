<?php
	...
	$GLOBALS['fc_config'] = array(
		...
		'version'         => '4.5.6', //architecture release . feature release . patch release
		...
		'photoloading' => array(
			'allowFileExt' 	   => 'jpg,gif,png,swf',// allowed file extensions, comma separated (to allow all extensions set to '')
		...
		'module' => array(
		 ...
		 /*
		'module' => array(
		 	'anchor'  => '0,-1',//the anchor point: -1,0,1,2,3 or 4 (0=centered,1-4=corners of space below roomlist) + 5-12 points
		 					//anchor of -1 means that module will occupy a floating window (not anchored with flashchat template)
