	...
	$GLOBALS['fc_config']['languages']['sv'] = array(
		...
		'dialog' => array(
			...
			'text' => array(
				...
				'title' => 'Titel',
				'mytextcolor' => 'Ã„nvänd min text färg för alla mottagna meddelande.',
			),
			...
			'common' => array(
				...
				'ext_not_allowed'    => 'Filtypen FILE_EXT är ej tillåtat. Var vänlig välj en fil av typ: ALLOWED_EXT',
			...
			'sharefile' => array(
				...
				'file_info_size'  => '<br>Filstorleken får vara maximal MAX_SIZE .',
