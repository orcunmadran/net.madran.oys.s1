...
class E107CMS {
    ...
    function E107CMS() {
        ...
        $this->getE107UserInfoStmt = new Statement("SELECT user_id as id, user_name AS login, user_admin, user_password as password FROM " . MPREFIX . "user WHERE user_name=? LIMIT 1");
        $this->getUserStmt = new Statement("SELECT user_id as id, user_name AS login, user_admin, user_password as password FROM " . MPREFIX . "user WHERE user_id=? LIMIT 1");
