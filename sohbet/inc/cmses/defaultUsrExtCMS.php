	...
	class DefaultCMS {
		...
		function DefaultCMS()
		{
			...
			$this->constArr = array(
					  ...
					  'spy_fld'     =>'_#_',
					  'spy_value'   =>'_#_',
					  'profile_path'=>'http://localhost/sk/sohbet/profile.php',
					  'profile_arg' =>'?kadi={$kadi}',
					  'admin_fld'=>'kategori',
					  'admin_value'=>'yonetici',
					  'logoff'		=>'true',
					  'moderator_fld'=>'kategori',					  
					  'moderator_value'=>'ogretime',
			);
		...
		function getUserProfile($userid)
		{
			...
			return "{$this->constArr['profile_path']}?kadi={$kadi}";
		}
		//-----------------------------------------------------------------------------------------
