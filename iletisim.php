  ...
  <tr><!-- row 3 -->
   ...
   <td colspan="18" valign="top" bgcolor="#FFFFFF"><!-- InstanceBeginEditable name="icerik" -->
     <table width="100%"  border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="70%" class="icyazi"><p class="baslik">Ýletiþim Formu</p></td>
         <td width="30%" rowspan="2" valign="top" class="baslik"><table width="100%"  border="0" cellspacing="5" cellpadding="5">
             <tr>
               <td class="arabaslik"><span class="baslik">Birim Sorumluluk Alanlarý</span></td>
             </tr>
             <tr>
               <td class="arabaslik">Bölüm Baþkanlýðý </td>
             </tr>
             <tr>
               <td class="icyazi"><ul>
                 <li>Sanal kampüs içerisindeki tüm akademik faaliyetler.</li>
               </ul></td>
             </tr>
             <tr>
               <td class="arabaslik">Öðrenci Ýþleri </td>
             </tr>
             <tr>
               <td class="icyazi"><ul>
                 <li>Ders, sistem ve sohbet odalarý kayýt iþlemleri </li>
               </ul></td>
             </tr>
             <tr>
               <td class="arabaslik">Teknik Hizmetler</td>
             </tr>
             <tr>
               <td class="icyazi"><ul>
                 <li>Sanal kampüsle ilgili tüm teknik hizmetler </li>
               </ul></td>
             </tr>
                  </table></td>
       </tr>
       <tr>
         <td class="icyazi"><form action="iletisimok.php" method="post" name="yolla" id="yolla">
           <table width="100%"  border="0" cellspacing="5" cellpadding="5">
             <tr>
               <td width="21%" class="icyazi"><div align="right"><strong>Ýlgili Birim </strong></div></td>
               <td width="3%" class="icyazi"><strong>:</strong></td>
               <td width="76%"><select name="birim" class="icyazi" id="birim">
                 <option>Seçiniz</option>
                 <option>Bölüm Baþkanlýðý</option>
                 <option>Öðrenci Ýþleri</option>
                 <option>Teknik Hizmetler</option>
               </select> 
                 <span class="altbaslik">*</span> </td>
             </tr>
             <tr>
               <td class="icyazi"><div align="right"><strong>Konu</strong></div></td>
               <td class="icyazi"><strong>:</strong></td>
               <td><input name="konu" type="text" class="icyazi" id="konu">   <span class="altbaslik">*</span></td>
             </tr>
             <tr>
               <td valign="top" class="icyazi"><div align="right"><strong>Mesaj</strong></div></td>
               <td valign="top" class="icyazi"><strong>:</strong></td>
               <td><textarea name="mesaj" cols="65" rows="10" class="icyazi" id="mesaj"></textarea></td>
             </tr>
             <tr>
               <td><div align="right">
               ...
               <td>&nbsp;</td>
               <td><input name="Submit" type="submit" class="butongiris" onClick="YY_checkform('yolla','konu','#q','0','Konu alaný boþ býrakýlamaz.','birim','#q','1','Lütfen bir birim seçiniz.');return document.MM_returnValue" value="Gönder"></td>
             </tr>
             <tr>
               <td><div align="right">
                 <input name="kime" type="hidden" id="kime" value="bote@baskent.edu.tr">
               </div></td>
               <td>&nbsp;</td>
