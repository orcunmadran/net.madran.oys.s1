...
mysql_select_db($database_iysconn, $iysconn);
$query_duyurular = "SELECT *, DATE_FORMAT(dbastrh, '%d.%m.%y') AS bas, DATE_FORMAT(dbittrh, '%d.%m.%y') AS bit FROM duyurular WHERE dbittrh < NOW() ORDER BY duyuruno DESC";
  ...
  <tr><!-- row 3 -->
   ...
   <td colspan="18" valign="top" bgcolor="#FFFFFF"><!-- InstanceBeginEditable name="icerik" -->
     <table width="100%"  border="0" cellspacing="5" cellpadding="5">
       <tr>
         <td width="70%" class="icyazi"><p class="baslik">Geçmiþ Duyurular</p></td>
         <td width="30%" class="icyazi">&nbsp;</td>
       </tr>
       <tr>
         <td valign="top" class="icyazi"><table width="100%"  border="0" cellspacing="5" cellpadding="0">
           <tr class="icyazi">
             <td width="21%"><strong>Yazar</strong></td>
             <td width="17%"><strong>Duyuru Tipi </strong></td>
             <td width="30%"><strong>Baþlýk</strong></td>
           ...
           <?php if ($totalRows_duyurular == 0) { // Show if recordset empty ?>
           <tr class="icyazi">
               <td colspan="5">Yayýn süresi bitmiþ duyuru bulunmamaktadýr. </td>
           </tr>
